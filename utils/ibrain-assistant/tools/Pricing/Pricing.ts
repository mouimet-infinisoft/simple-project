    ...
    if (args && args.plan) {
      ...
      switch (args.plan.toLowerCase()) {
        ...
        case 'business':
          ...
          break;
        default:
          pricingInfo = `I'm sorry, I don't have information about the "${args.plan}" pricing plan. Please ask for details about one of the available plans: Free Trial, Basic, or Business.`;
      }
    } else {
      // No specific plan asked, provide general information
